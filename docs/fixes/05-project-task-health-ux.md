...
> **历史修复设计：** 本文记录当时的项目/任务/健康体验修复。涉及独立启动页、普通文件夹初始化、项目打开分类、信任、兼容、修复与启动策略的内容，已由 [首次使用与打开已有知识库规范](../superpowers/specs/2026-07-30-first-run-project-open-workbench-design.md) 取代；其余实现证据仅作追溯。
