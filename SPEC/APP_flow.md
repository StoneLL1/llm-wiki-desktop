...
- `PRD.md`
- `SPEC.md`
- 真实样本库（仓库外维护，见 `docs/testing/sample-knowledge-base.md`；原生结构见 `SPEC.md` §5）
...
样本库（数百个 Markdown 文件，仓库外维护）是性能基准的参照：首版目标应覆盖约 200-500 篇 Wiki 页面。图谱首次构建可以进入后台任务，但必须展示进度并允许取消。
