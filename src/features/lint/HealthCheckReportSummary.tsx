...
export function HealthCheckReportSummary({ report }: { report: HealthCheckReport }) {
  ...
  return (
    <section aria-label={t("lint.healthReport.title")} className="border-b border-[var(--border)] px-4 py-3 text-[12px] text-[var(--text-secondary)]">
      <h2 className="mb-2 text-[13px] font-medium text-[var(--text-primary)]">{t("lint.healthReport.title")}</h2>
