  ...
  return (
    <section className="mx-4 mb-3 flex items-start gap-3 rounded-[var(--radius-md)] border border-[var(--warning)] bg-[var(--warning-soft)] px-3 py-3" role="alert" aria-labelledby="import-migration-notice-title">
      ...
      <div className="min-w-0 flex-1">
        <h2 id="import-migration-notice-title" className="m-0 text-[13px] font-semibold">{t(unavailable ? "importV2.migration.unavailableTitle" : "importV2.migration.noticeTitle")}</h2>
        <p className="m-0 mt-1 text-[11px] text-[var(--text-secondary)]">{t(unavailable ? "importV2.migration.unavailableBody" : "importV2.migration.noticeBody")}</p>
      </div>
