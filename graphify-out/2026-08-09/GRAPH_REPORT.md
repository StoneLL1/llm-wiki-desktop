...
Cohesion: 0.05
Nodes (85): Fixability, LintIssueSource, append_utf8_chunk(), builds_provider_specific_requests_without_leaking_secret_into_body(), config(), extract_buffered_response(), extract_stream_delta(), extract_text() (+77 more)
...
Cohesion: 0.17
Nodes (21): canonical_task_state_root(), EnqueueWorkflow, reset_stage(), Mutex, Option, Path, PathBuf, Result (+13 more)
...
Cohesion: 0.12
Nodes (38): CompileManifest, CompilePlan, byok_agent_and_skill_include_shared_decision_rules(), byok_prompt_reads_cjk_extracted_markdown_from_compile_workspace(), CompileApplyOutcome, CompileBackup, CompileGenerationPolicy, CompileService (+30 more)
...
### Community 189 - "bindGraphCanvasInteractions"
Cohesion: 0.26
...
### Community 498 - "dragDrop.ts"
Cohesion: 0.36
Nodes (6): DragDropEnvelope, DragDropSubscription, DragDropUpdate, reduceDragDrop(), subscribeToDragDrop(), position
...
### Community 512 - "import_v2_migration_apply.rs"
Cohesion: 0.67
...
- `SessionStore` (5× useful, score=4.609682441)
- `WorkflowAccessSnapshot` (4× useful, score=3.663844079) _(code changed — re-verify)_
- `TaskService` (3× useful, score=2.780866665) _(code changed — re-verify)_
