...
url: "https://mp.weixin.qq.com/s/7B4LpoMy6LQJo0RsQ15Xhg"
source: "微信公众号"
author: "逛逛"
account: "逛逛GitHub"
pub_date: 2026-05-31
...
## 02 OpenToonz — 宫崎骏用了几十年的动画软件，免费开源
...
## 04 English-level-up-tips — 4.8 万程序员收藏的英语学习指南
...
教你怎么用 Gemini 做英语学习主引擎，把 Gem、Live、Guided Learning、Canvas 等串成完整的训练流程。同时讲了 ChatGPT、Claude、Perplexity、DeepL Write 如何分工使用。
