...
url: "https://github.com/wps365-open/cli"
author: "wps365-open"
stars: 71
forks: 2
language: "PowerShell"
...
> WPS 365 官方 CLI 工具 — 面向开发者与 AI Agent 的命令行入口。
...
| `auth logout` | 删除本地 token | 退出登录，凭证保留可直接重新 login |
| `auth clean` | 清理所有认证数据 | 凭证损坏时完全重置 |
...
| `WPS365_KEYRING_PASSWORD` | 文件后端加密密码（可选） |
